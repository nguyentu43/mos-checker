    ...
    public class Db
    {
        public static void initDb()
        {
            ...
            List<Question> list1 = new List<Question>()
            {
                ...
                {
                    Title = "Theme",
                    Content = "<div class='title'>Apply a <b>theme</b> to document</div><div class='position'>Entire document</div><div class='list'>* Theme: <b>Ion</b></div>",
                    Help = "1. In the DESIGN tab, Document Formatting group, select the Theme drop-down.\n2. Select Ion."
                },
                new Question()
                {
                    Title = "Background Color",
                    Content = "<div class='title'>Change the background color.</div><div class='position'>Entire document</div><div class='list'><b>Blue-Gray, Accent 5, Lighter 60%</div>",
                    Help = "1. In the DESIGN tab, Page Background group, select Page Color.\n2. Select Blue-Gray, Accent 5, Lighter 60%."
                },
                new Question()
                {
                    Title = "Page Border",
                    Content = "<div class='title'>Add a <b>page border</b> to a document.</div><div class='position'>Entire document</div><div class='list'>* <b>Box</b><br>* Accept all defaults</div>",
...
3. Click OK."
                ...
                {
                    Title = "Breaks",
                    Content = "<div class='title'>Add breaks to separate portions of a document.</div><div class='position'>First page, fifth paragraph. At the beginning of the line, <b>For each toxin…</b></div><div class='list'>* <b>Section Break (Continuous)</b></div><div class='position'>Third page, third paragraph. At the beginning of the line, <b>Question: I have a serious pain…</b></div><div class='list'>* <b>Section Break (Continuous)</b></div><div class='position'>Third page, at the beginning of the heading <b>Question and Answer with Dr. Nelson</b></div><div class='list'>* <b>Page Break</b></div>",
                    Help = @"I.
...
3. Select Page Break."
            ...
            test_1_office_2013.Questions.Add("1-Newsletter", list1);

            List<Question> list2 = new List<Question> {
                new Question()
                {
                    Title = "Orientation",
                    Content = "<div class='title'>Change the <b>orientaton</b> of specific pages.</div><div class='position'>First page only</div><div class='list'>* <b>Landscape</b> (Note: All other pages are to remain in <b>Portrait</b> orientation)</div>",
...
(Hint: All except the first page of the document should remain in Portrait orientation. If not, reinsert your breaks in the previous tasks above)."
                ...
                {
                    Title = "Bulleted List",
                    Content = "<div class='title'>Create a bulleted list from a selection of text.</div><div class='position'>First page, fourth paragraph, <b>Dry mouth</b> through <b>Addictive personality.</b></div><div class='list'>* <b>Checkmarks</b><br>* <b>Indentation \"0.5\" </b>(1.27 cm)<br> * 3 <b>columns</b></div>",
...
9. Select Three."
                ...
                {
                    Title = "Insert Image",
                    Content = "<div class='title'>Add images to a document.</div><div class='position'>First page, upper right corner.</div><div class='list'>* <b>doctor.png</b><br>* Position: <b>Top Riht with Square Text Wrapping</b><br>* Picture Style: <b>Thick Matte, Black</b></div>",
...
8. Select Thick Matte, Black."
                ...
                {
                    Title = "Shapes",
                    Content = "<div class='title'>Insert a shape into the document.</div><div class='position'>In the empty space on the first page.</div><div class='list'>* <b>Simley Face</b><br>* Style: <b>Colored Outline - Black, Dark 1</b></div>",
...
6. Select Colored Outline - Black, Dark 1."
                ...
                {
                    Title = "Caption",
                    Content = "<div class='title'>Insert a caption under the shape.</div><div class='position'>Under the <b>Smiley Face</b> shape</div><div class='list'>* Figure caption <br>* Position below shape<br>* Text: <b>\"When you aren't toxic, you are happy!\"</b><br>* <b>Exclude label from caption</b<br>* Drag to center below shape</div>",
...
8.Use the resize handles on the caption box to center the caption below the shape.",
            ...
            test_1_office_2013.Questions.Add("2-Page 1", list2);

            List<Question> list3 = new List<Question> {
                new Question()
                {
                    Title = "Table",
                    Content = "<div class='title'>Convert text to a table.</div><div class='position'>Second page, below the first paragraph. beginning with, <b>Toxin</b> through <b>Some Nausea.</b></div><div class='list'>* 4 <b>Columns</b><br>* Separate at tabs</div>",
...
5. Click OK."
                ...
                new Question()
                {
                    ...
                    Content = "<div class='title'>Modify Table Data</div><div class='position'>Table column 4 <b>(Side Effects)</b>, row 5 (<b>Iron</b>).</div><div class='list'>* Delete the text, <b>None</b><br>* Insert the text, <b>\"Constipation\"</b></div>",
...
2. Type the text, ""Constipation""."
                ...
                {
                    Title = "Table Style",
                    Content = "<div class='title'>Apply a style to a table.</div><div class='position'>Entire table</div><div class='list'>* <b>Grid Table 4 - Accent 4</b></div>",
...
3. Under the Grid Tables section, select Grid Table 4 - Accent 4."
                ...
                {
                    Title = "Format Table",
                    Content = "<div class='title'>Add formatting to the table headers.</div><div class='position'>Table headers (<b>Toxins</b> to <b>Side Effects</b>)</div><div class='list'>* Center align</div>",
...
2. In the TABLE/LAYOUT tab, Alignment group, select Align Center."
                ...
                {
                    Title = "Modify Style",
                    Content = "<div class='title'>Change a style</div><div class='position'><b>Intense Emphasis</b> style</div><div class='list'>* <b>Black, Text 1, lighter 15%</b><br>* Font size <b>12</b></div>",
...
10. Close the Styles pane by clicking the X in the upper-right corner."
                ...
                {
                    Title = "Apply Style",
                    Content = "<div class='title'>Apply a style to selection of text.</div><div class='position'>Second page, the sentence <b>Are You Ok, Sparky?</b></div><div class='list'>* Title</div><div class='position'>Second page, the sentence <b>What about our pets?</b></div><div class='list'>* <b>Intense Emphasis</b></div>",
                    Help = @"I.
...
3. Select Intense Emphasis."
                ...
                {
                    Title = "Insert Image",
                    Content = "<div class='title'>Add images to a document.</div><div class='position'>Second page, below the subheading, <b>What about our pets?</b></div><div class='list'>* <b>kitty.jpg</b><br>* Height: \"<b>50</b>\" percent<br>* Width: \"<b>50</b>\" percent<br>* <b>Tight wrap</b><br><b>Bevel Divot</b> style</div>",
...
10. Select Bevel, then click Divot."
                ...
                {
                    Title = "WordArt",
                    Content = "<div class='title'>Convert select text to <b>WordArt</b></div><div class='position'>Second page, the letter <b>A</b> in the heading, <b>Are You Ok, Sparky?</b></div><div class='list'>* <b>WordArt</b> Style: <b>Fill - Black, Text 1, Outline - Background 1, Hard Shadow -Background 1</b></div>",
...
3. Select Fill - Black, Text 1, Outline - Background 1, Hard Shadow -Background 1."
            ...
            test_1_office_2013.Questions.Add("3-Page 2", list3);

            List<Question> list4 = new List<Question> {
                new Question()
                {
                    Title = "Text Formatting",
                    Content = "<div class='title'>Add direct formatting to a selection of text.</div><div class='position'>Third page, sixth paragraph, the phrase <b>lukewarm water.</b></div><div class='list'>* <b>Double Underline</b></div>",
...
3. Select Double underline."
                ...
                {
                    Title = "Apply Style",
                    Content = "<div class='title'>Apply Style</div><div class='position'>Last page, the sentence <b>Question and Answer with Doctor Nelson.</b></div><div class='list'>* <b>Heading 1</b></div>",
...
3. Select Heading 1."
                ...
                {
                    Title = "Margins",
                    Content = "<div class='title'>Change the margins of specific pages.</div><div class='position'>Last page, beginning with <b>Question: I have a…</b> through <b>…questions to Dr. Nelson.</b></div><div class='list'>* Wide Margins</div>",
...
3. Select Wide."
                ...
                {
                    Title = "Footnote",
                    Content = "<div class='title'>Add a <b>footnote</b> to the document.</div><div class='position'>In the heading on the last page, associate the <b>footnote</b> to the text, <b>Dr. Nelson.</b></div><div class='list'>* Footnote text: Cut and paste the paragraph beginning with <b>Dr. William Nelson...</b> to <b>... a recreational vehicle.</b></div>",
...
4. Paste the text in the footnote at the bottom of the page."
                ...
                {
                    Title = "Hyperlink",
                    Content = "<div class='title'>Add a <b>hyperlink</b> to selected text.</div><div class='position'>Last paragraph, <b>hyperlink</b> the text <b>email all of your questions.</b></div><div class='list'>* Link to: \"<b>williamnelson@hypotheticaluniversity.com</b>\"</div>",
...
5. Click OK."
            ...
            test_1_office_2013.Questions.Add("4-Page 3", list4);

            List<Question> list5 = new List<Question> {
                new Question()
                {
                    Title = "Macro",
                    Content = "<div class='title'>Create a <b>macro.</b></div><div class='position'>Store the <b>macro</b> in the current document</div><div class='list'>* Name the macro, \"<b>Emphasis</b>\"<br>* Actions: <b>Bold, Underline</b></div>",
...
8.In the VIEW tab, Macros group, select the drop - down for Macros.
 9.Select Stop Recording."
                ...
                {
                    Title = "Navigate",
                    Content = "<div class='title'>Use the <b>Navigation pane.</b></div><div class='position'>Find all instances of <b>Toxins</b> in the document</div><div class='list'>* Apply the <b>Emphasis</b> macro</div>",
...
6. Click the X in the upper-right corner of the Navigation pane to close it."
                ...
                {
                    Title = "Quick Parts",
                    Content = "<div class='title'>Use <b>Quick Parts</b> to insert a <b>Publish Date.</b></div><div class='position'>End of last page</div><div class='list'>* <b>Publish Date</b></div>",
...
4. Select Publish Date"
                ...
                {
                    Title = "Page Numbers",
                    Content = "<div class='title'>Insert page numbering.</div><div class='position'>Bottom of Page</div><div class='list'>* <b>Ribbon</b> (under <b>With Shapes</b> section)</div>",
...
3. Scroll to the section, With Shapes, and select Ribbon."
                ...
                new Question()
                {
                    ...
                    Content = "<div class='title'>Add values to document property fields.</div><div class='position'>Title</div><div class='list'>* <b>Health Newsletter</b></div>",
...
3. Type ""Health Newsletter""."
                ...
                new Question()
                {
                    ...
                    Content = "<div class='title'>Limit editing in this document</div><div class='position'><b>Allow only this type of editing in the document</b></div><div class='list'>* Tracked Changes<br>* Password: \"<b>GMetrix</b>\"</div>",
...
6. Type ""GMetrix"" twice. Click OK."
                ...
                new Question()
                {
                    ...
                    Content = "<div class='title'>Change document options.</div><div class='position'>Display options</div><div class='list'>* Enable: <b>Print document properties</b></div><div class='position'>Proofing options</div><div class='list'>* Disable: <b>Check spelling as you type</b></div><div class='position'>Advanced Options</div><div class='list'>* <b>Allow Open in Draft View</b></div>",
                    Help = @"I.
...
Note: If you do not close the Word Options menu before grading your test it will cause an issue with scoring."
            ...
            test_1_office_2013.Questions.Add("6-Final Steps", list5);
            ...
            List<Question> project1 = new List<Question>()
            {
                new Question()
                {
                    Title = "OVERVIEW",
...
3. In the Picture Styles group, select Soft Edge Rectangle."
            ...
            test_1_office_2016.Questions.Add("1", project1);

            List<Question> project2 = new List<Question> {
                new Question()
                {
                    Title = "OVERVIEW",
...
5. To the right of the inserted photo, click the Layout Options icon. Beneath With Text Wrapping click Tight. Accept all other defaults."
            ...
            test_1_office_2016.Questions.Add("2", project2);

            List<Question> project3 = new List<Question> {
                new Question()
                {
                    Title = "OVERVIEW",
...
3. In the Picture Effects drop-down menu, select 3-D Rotation. In the section Parallel, select Off Axis 1 Right."
            ...
            test_1_office_2016.Questions.Add("3", project3);

            List<Question> project4 = new List<Question> {
                new Question()
                {
                    Title = "OVERVIEW",
...
3. Scroll down and select Integral."
            ...
            test_1_office_2016.Questions.Add("4", project4);

            List<Question> project5 = new List<Question> {
                new Question()
                {
                    Title = "OVERVIEW",
...
3. Click anywhere outside the graphic to deselect it."
            ...
            test_1_office_2016.Questions.Add("5", project5);

            List<Question> project6 = new List<Question> {
                new Question()
                {
                    Title = "OVERVIEW",
...
3. In the Cell Size group, change the Width to 1.8""."
            ...
            test_1_office_2016.Questions.Add("6", project6);

            List<Question> project7 = new List<Question> {
                new Question()
                {
                    Title = "OVERVIEW",
                    Content = @"Scuba
